...
def myMetrics(myData, theStr):
	...
	theStr = theStr + myPhoneType + "','" + myRoam + "', '" + myActNetType + "'"	
...
def myLocation(myData, theStr):
	...
	#append the new values to the end of the existing string, 
	theStr = theStr + "," + myLon + "," + myLat + "," + myAcc + "," + myGID
	return(theStr)
...
provList = ["att","sprint","tmobile","vz", "other"] #"att","sprint","tmobile","vz", "other"
...
for prov in provList:
	...
	myDir = "/Users/feomike/documents/analysis/2013/mmba/data/" + prov + \
    	    "/json/" + "2013" + month + "/"
	myDir = "/Users/feomike/downloads/mmba_downloads/" + prov + "/json/"
	os.chdir(myDir)
